...
/////////////////////////
    ...
    $strategy->AddWeekDay( \libdatephp\cDate::DOW_MONDAY );
    $strategy->AddWeekDay( \libdatephp\cDate::DOW_THURSDAY );
...
// goto actual_subprogram;
    ...
    if ( count( $ary ) != count( $a_good )  ) die( "\n error: different array sizes" );
    if ( ! in_array( \libdatephp\cDate::DOW_MONDAY, $ary ) ||  ! in_array( \libdatephp\cDate::DOW_THURSDAY, $ary ) ) die( "\n error: different values in arrays" );
...
*/
    ...
    $dt_first = new \libdatephp\cDate( 5, 11, 2017 );
...
//
    ...
    $dt_first = new \libdatephp\cDate( 7, 29, 2017 );
    ...
    // set start and ending date
    $strategy->SetStartDate( new \libdatephp\cDate( 4, 8, 2016 ) );
    $strategy->SetEndDate( new \libdatephp\cDate( 3,3,2018 ) );
    ...
    $dt_first = new \libdatephp\cDate( 1, 1, 2018 );
